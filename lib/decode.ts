...
/**
 * Returns true for Docker-style auto-generated project names used by Claude Code
 * when a session runs outside any real project directory.
 * e.g. "jovial-ramanujan-bcb2e8", "jovial-curran-281467"
 */
export function isAutoGeneratedProject(projectPath: string): boolean {
  if (!projectPath) return true
  const name = projectDisplayName(projectPath)
  return /^[a-z][a-z0-9]*-[a-z][a-z0-9]*-[0-9a-f]{6,8}$/.test(name)
}
